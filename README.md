...
![imagen](./evidencias_1/iniciar_servicios_docker_evidencia.png)

2. hace una peticion HTTP a mi archivo nginx.conf local
![imagen](./evidencias_1/realizar_peticion_http_evidencia.png)

3. error 401 unauthorized falla ya que envia la peticion sin los headers obligatorios
![imagen](./evidencias_1/401_Unauthorized_realizar_peticion_http_evidencia.png)

4. muestra el estado del contenedor
![imagen](./evidencias_1/estado_de_los_contenedores_configurados_evidencias.png)
